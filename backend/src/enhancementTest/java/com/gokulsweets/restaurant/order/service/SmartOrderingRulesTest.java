...
class SmartOrderingRulesTest {
    ...
    @Test void allFlagsDefaultOffAndSelectionRequiresAvailability() {
        ...
        assertThat(controller.features()).isEqualTo(new StorefrontFeaturesController.Features(false, false, false, false, false, false, false, false, false, 30, LocalDate.of(2026, 9, 22)));
